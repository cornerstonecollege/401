...
(NSInteger)HP attack:(NSInteger)attack andDefense:(NSInteger)defense
{
    ...
    if (self) {
        ...
        [self.attackPP setObject:[NSMutableArray arrayWithObjects:@25, @25, @45, nil] forKey:@4];
        [self.attackPP setObject:[NSMutableArray arrayWithObjects:@5, @5, 105, nil] forKey:@5];
        [self.attackPP setObject:[NSMutableArray arrayWithObjects:@25, @25, @65, nil] forKey:@6];
